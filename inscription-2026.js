(function (global) {
  ...
  var NOREFUND='<p class="no-refund"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" aria-hidden="true"><path d="M12 9v4m0 4h.01M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/></svg><span><b>Aucun remboursement une fois le paiement effectué.</b> C’est pourquoi le club offre <a href="https://app.ojnice.com/essai">2 cours d’essai gratuits</a> : testez avant de vous inscrire.</span></p>';
  var NOREFUND_SHORT='<p class="no-refund"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" aria-hidden="true"><path d="M12 9v4m0 4h.01M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/></svg><span><b>Aucun remboursement une fois le paiement effectué.</b> C’est pourquoi le club offre 2 cours d’essai gratuits : testez avant de vous inscrire.</span></p>';
    ...
    function render(focus){
      ...
      root.innerHTML='<div class="reg-intro"><span class="eyebrow">Saison 2026 / 2027</span><span class="reg-simple">Votre cours. Votre inscription.</span></div>'+NOREFUND
